...
import MorePoints from "../../components/MorePoints/MorePoints";
          ...
          <div className='flex justify-between items-center mb-5'>
            ...
            <div className='space-x-3'>
              <button
                ...
                onClick={handlePrev}
                className='p-3 bg-[#fff] shadow-md rounded-xl disabled:bg-[#EBEBE4] disabled:text-slate-400 disabled:cursor-default'>
                <FaAngleLeft />
              </button>
              <button
                disabled={
